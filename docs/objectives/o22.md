...
```
This resulted in nothing useful being found and I moved back to the registration portal to begin testing the log in. The hint mentioned testing basic SQLi so I was my goal. I started up BurpSuite so I could see the response and loaded the registration portal again. I immediately failed the penetration test!!!
