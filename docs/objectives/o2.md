...
The [hint](#hints) "*Defang All The Thingz*" mentions that the PTAS system does a good job, but that they are still working on a command that "defangs ALL scenarios". 
