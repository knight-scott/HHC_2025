...
![zoomed](../img/objectives/o24/signals.png)
...
I used a lot of LLM assistance to figure this one out and got a lot of exposure to new things, which was fun!<br/>
I started with checking out the Network tab of Developer Tools. 
